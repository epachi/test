...
public class FloodDepthEfficient {
    ...
    public static void main(String[] args) {
        FloodDepthEfficient solution = new FloodDepthEfficient();
...
//    This solution has a time complexity of O(N) as it iterates through the array three times, and a space complexity of O(N) to store the left and right maximum heights.